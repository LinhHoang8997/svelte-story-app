...
>
  <ul>
    ...
    {#each chapters_data as chapter}
      <li>
        <a
          href="/chapters/{chapter.data.attributes.slug}"
          ...
          class:bg-orange-800={chapter.data.attributes.slug === current_chapter_slug}
          class:text-secondary={chapter.data.attributes.slug === current_chapter_slug}
          >{chapter.data.attributes.title}</a
        >
      </li>
    {/each}
  </ul>
