...
<section
  class="reader_wrapper flex flex-col md:basis-5/6 items-center transition-all duration-500 bg-orange-200"
>
...
<style>
  .reader_wrapper {
    background-image: url("$lib/assets/images/patterns/fabric_1.webp");
